sap.ui.controller("sap.hana.democontent.epm.salesdashboard.view.details", {
	...
	onRefresh: function(oEvent) {
		...
		$.ajax({
				type: "GET",
				url: "/v2/shine/SalesOrderHeader/$count",
				async: true,
				...
				error: function(jqXHR, textStatus, errorThrown) {
					sap.ui.commons.MessageBox.show("Error in loading Sales Table",
						"ERROR",
						"Error");
					return;
				}
	 ...
	 */
	onInit: function() {
		this.deleteModel = new sap.ui.model.odata.ODataModel("/v2/shine/", true);
	},
    ...
    createNewDialogContent: function(oController) {
        ...
        view.oComboBoxBp.setModel(new sap.ui.model.odata.ODataModel("/v2/shine/",
            true));
		...
		oComboBoxPd.setModel(new sap.ui.model.odata.ODataModel("/v2/shine/",true));
    ...
    createNewLineItemContent: function(oController) {
        ...
        this.oComboBoxPd.setModel(new sap.ui.model.odata.ODataModel("/v2/shine/",
            true));
