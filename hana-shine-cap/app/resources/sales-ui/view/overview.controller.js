sap.ui.controller("sap.hana.democontent.epm.salesdashboard.view.overview", {
    ...
    onInit: function() {
        ...
        var oDiscountModel = new sap.ui.model.odata.ODataModel("/v2/shine/");
        ...
        var oSalesRegionModel = new sap.ui.model.odata.ODataModel("/v2/shine/", true);
        ...
        var oSalesCountryModel = new sap.ui.model.odata.ODataModel("/v2/shine/", true);
        ...
        var oSalesRankModel = new sap.ui.model.odata.ODataModel("/v2/shine/", true);
    ...
    onFilterChange: function(aFilter) {
    	var oDiscountModel;
    	    	...
    	    	oDiscountModel = new sap.ui.model.odata.ODataModel("/v2/shine/",true);
